...
// Например, строка "Старший братец ПОНЕДЕЛЬНИК ..." будет преобразована
// в "Старший братец MONDAY..."
...
`;
const translationDaysWeek = (string) => {
  let newStr = string
...
console.log(translationDaysWeek(str));
